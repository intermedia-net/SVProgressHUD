...
typedef NS_ENUM(NSUInteger, SVProgressHUDAnimationType) {
	...
	SVProgressHUDAnimationTypeCustom NS_SWIFT_NAME(custom)
};
...
/// would be used for SVProgressHUDAnimationTypeCustom
/// @discussion Default: nil.
@property (strong, nonatomic, nullable) UIImageView *loadingImageView; 
